...
<head>
  ...
  <title>register_Mora Soft</title>
...
{{--        </x-slot>--}}
        ...
        <form method="POST" action="{{ route('register') }}">
            ...
            <!-- Name -->
            <div>
                <x-label for="fname" :value="__('First Name')" style="color:#fff"></x-label>

                <x-input id="fname" class="block mt-1 w-full" type="text" name="fname" :value="old('fname')" required autofocus></x-input>
            </div>
                <br>
            <div>
                <x-label for="lname" :value="__('Last Name')" style="color:#fff"></x-label>
            ...
            <!-- Email Address -->
            <div class="mt-4">
                <x-label for="email" :value="__('Email')" style="color:#fff"></x-label>
            ...
            <!-- Password -->
            <div class="mt-4">
                <x-label for="password" :value="__('Password')" style="color:#fff"></x-label>
            ...
            <!-- Confirm Password -->
            <div class="mt-4">
                <x-label for="password_confirmation" :value="__('Confirm Password')" style="color:#fff"></x-label>
            ...
            <div class="flex items-center justify-end mt-4">
                <a class="underline text-sm text-gray-600 hover:text-gray-900" style="color:#fff" href="{{ route('login') }}">
